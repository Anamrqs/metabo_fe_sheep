...
sed -i 's/repetsInner/5/g' template_V3.R
sed -i 's/foldsInner/50/g' template_V3.R
sed -i 's/repetsOutter/50/g' template_V3.R
sed -i 's/foldsOutter/5/g' template_V3.R
sed -i 's/PREDICTIONS/ingestion/g' template_V3.R
sed -i 's/PREDICTEURS/all/g' template_V3.R
sed -i 's/DATASET/df_SC_V3/g' template_V3.R
sed -i 's/NCOMP/6/g' template_V3.R
sed -i 's/LIST_KEEPX/c(seq(1,5,1),10,25,50,100)/g' template_V3.R
sed -i 's/MODEL/spls/g' template_V3.R
sed -i 's/RANGE_X/c(13:length(df_prediction))/g' template_V3.R
sed -i 's/RANGE_Y/7/g' template_V3.R
sed -i 's/CORRECTION/SC/g' template_V3.R

# Modif script name
mv template_V3.R model250_Ingestion_All_SC_V3.R

# Run Rscript, output a logfile -- prediction ingestion --
Rscript --vanilla --verbose model250_Ingestion_All_SC_V3.R > slurm-${SLURM_JOB_ID}.Rout 2>&1 
...
mv model250_Ingestion_All_SC_V3.R /work/$USER/Scripts_V3/
mv $SCRATCHDIR ~/work/
